...
export class MultiversXProvider implements ProviderInterface {
  ...
  async getNetwork(): Promise<NetworkStatus> {
    ...
    switch (chainID) {
      case '1': id = 198001; break; // id generated by: generateChainId(this.chainId);
      case 'T': id = 198002; break;
      case 'D': id = 198003; break;
      default: throw new Error(`${this.loggerPrefix} unknown chainID ${chainID}`)
    }
