...
/** Client for an on-chain smart contract module with module reference 'b3938520c58bbcdedbd557a46616410c5d4e5a319c526af1fb4815e91a5cdb08', can be used for instantiating new smart contract instances. */
 ...
 * Construct a RegistryModule client for interacting with a smart contract module on chain.
 * This function ensures the smart contract module is deployed on chain.
 * @param {RegistryModule} moduleClient - The client of the on-chain smart contract module with referecence 'b3938520c58bbcdedbd557a46616410c5d4e5a319c526af1fb4815e91a5cdb08'.
 * @throws If failing to communicate with the concordium node or if the module reference is not present on chain.
 * @returns {RegistryModule} A module client ensured to be deployed on chain.
 */
