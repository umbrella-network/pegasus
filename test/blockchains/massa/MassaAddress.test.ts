...
describe('MassaAddress', () => {
  it.only('sort', async () => {
    ...
    const a2 = 'P1gN7svCytzkDegn3BAnHdtaT1nQux7krzFbj3KiweHgJFnJPpy';
    // const a2 = 'P1QV6AsrtPdZqk9BVyMMfFCDgYEaMaSBatnCk8xs1jJzcMGNeFa';

    console.log('addr1', MassaAddress.toHex(a1), BigInt(MassaAddress.toHex(a1)));
    console.log('addr2', MassaAddress.toHex(a2), BigInt(MassaAddress.toHex(a2)));
    console.log('addr2', MassaAddress.toU256(a2));
